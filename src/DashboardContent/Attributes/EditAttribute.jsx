      ...
      <div className="p-8 rounded-lg shadow-lg w-full mx-auto h-full mt-5">
        ...
        {isLoadingData ? (
          ...
          <form onSubmit={handleSubmit} className="text-md ">
            ...
            <button
              type="submit"
              className={`btn bg-blue text-white hover:bg-blue focus:ring-4 focus:outline-none focus:ring-blue  rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center ${
